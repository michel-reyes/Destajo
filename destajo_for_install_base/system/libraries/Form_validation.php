...
class CI_Form_validation {
    ...
    public function is_unique($str, $field)
    {
        ...
        // Obteniendo el total de registros obtenidos de la consulta
	...
	/**
	 * Human_data by Michel Reyes
	 *
	 * @access	public
	 * @param	string
	 * @return	bool
	 */
	public function human_date($str)
	{
		return ( ! preg_match("/^([0-9]{1,2}\/([0-9]{1,2})\/([0-9]{4}))/i", $str)) ? FALSE : TRUE;
	}

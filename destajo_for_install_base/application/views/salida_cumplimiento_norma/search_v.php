<?php echo form_open('salida_cumplimiento_norma/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_salida_cumplimiento_norma');
    $b_criterio = $this->session->userdata('buscar_criterio_salida_cumplimiento_norma');
    $b_texto = $this->session->userdata('buscar_texto_salida_cumplimiento_norma');
    $b_periodo = $this->session->userdata('search_periodo_salida_cn');
    $datepicker = NULL;
?>

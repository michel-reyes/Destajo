<?php echo form_open('modo_descarga/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_modo_descarga');
    $b_criterio = $this->session->userdata('buscar_criterio_modo_descarga');
    $b_texto = $this->session->userdata('buscar_texto_modo_descarga');
?>

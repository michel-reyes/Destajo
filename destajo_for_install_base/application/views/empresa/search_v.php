<?php echo form_open('empresa/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_empresa');
    $b_criterio = $this->session->userdata('buscar_criterio_empresa');
    $b_texto = $this->session->userdata('buscar_texto_empresa');
?>

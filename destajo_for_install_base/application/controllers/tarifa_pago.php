...
class Tarifa_pago extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('fk_categoria_operario_id', 'Categor&iacute;a del operario', 'trim|required|xss_clean|is_unique[tarifa_pago.fk_categoria_operario_id]');
        $this->form_validation->set_rules('tarifa_menor', 'Tarifa para viajes menores', 'trim|required|xss_clean|decimal');
        $this->form_validation->set_rules('tarifa_mayor', 'Tarifa para viajes mayores', 'trim|required|xss_clean|decimal');
        $this->form_validation->set_rules('tarifa_completa', 'Tarifa completa', 'trim|required|xss_clean|decimal');
        // Valor no obligatorio, pero decimal
        if ($this->input->post('tarifa_interrupcion')) { 
            $this->form_validation->set_rules('tarifa_interrupcion', 'Tarifa para interrupciones', 'trim|required|xss_clean|decimal');
        }

...
class Carga_descarga extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('codigo', 'C&oacute;digo', 'trim|required|xss_clean|integer|is_unique[carga_descarga.codigo]');
        $this->form_validation->set_rules('fk_lugar_carga_id', 'Lugar de carga', 'trim|required|xss_clean');
        $this->form_validation->set_rules('fk_lugar_descarga_id', 'Lugar de descarga', 'trim|required|xss_clean');

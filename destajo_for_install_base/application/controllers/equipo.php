...
class Equipo extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('numero_operacional', 'N&uacute;mero operacional', 'trim|required|xss_clean|max_length[6]|is_unique[m_equipo.numero_operacional]');

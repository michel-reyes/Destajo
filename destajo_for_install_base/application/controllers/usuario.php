...
class Usuario extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('email', 'Email', 'trim|required|xss_clean|max_length[150]|valid_email');
        $this->form_validation->set_rules('nombre_login', 'Nombre de login', 'trim|required|xss_clean|max_length[10]|min_length[4]|is_unique[usuario.nombre_login]');
        ...
        $this->form_validation->set_rules('fk_empresa_id', 'Empresa', 'trim|required|xss_clean');
        $this->form_validation->set_rules('fk_perfil_id', 'Perfil', 'trim|required|xss_clean');

...
class Capacidad_carga extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('fk_equipo_id', 'N&uacute;mero operacional del equipo', 'trim|required');
		if ($this->input->post('viajes_promedio'))
		{
			$this->form_validation->set_rules('viajes_promedio', 'Viajes promedio', 'trim|required|integer');
		}
		if ($this->input->post('entregas_promedio'))
		{
			$this->form_validation->set_rules('entregas_promedio', 'Entregas promedio', 'trim|required|integer');
		}        
        $this->form_validation->set_rules('capacidad_carga', 'Capacidad de carga', 'trim|required|integer');
        $this->form_validation->set_rules('tipo_de_producto', 'Tipo de producto', 'trim|required');

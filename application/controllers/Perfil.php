...
class Perfil extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('perfil', 'Perfil', 'trim|required|max_length[100]|is_unique[perfil.perfil]');
        $this->form_validation->set_rules('descripcion', 'Descripci&oacute;n', 'trim|required|max_length[255]');
        $this->form_validation->set_rules('no_eliminar', 'eliminar', 'trim|required');

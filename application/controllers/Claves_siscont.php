...
class Claves_siscont extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('clave', 'Clave', 'trim|required|max_length[200]');
        $this->form_validation->set_rules('sigla', 'Sigla', 'trim|required|max_length[5]|is_unique[m_claves_siscont.sigla]');
        $this->form_validation->set_rules('valor', 'Valor', 'trim|required|max_length[10]');

        if ($this->input->post('unidad_medida'))
            $this->form_validation->set_rules('unidad_medida', 'Unidad de medida', 'trim|required|max_length[10]');    

...
class Entrada extends CI_Controller {
    ...
    public function validar()
    {
        ...
        if ($this->input->post('hoja_de_ruta')) {
            $this->form_validation->set_rules('hoja_de_ruta', 'Hoja de ruta', 'trim|required|max_length[15]');
        }
        ...
        if ($this->input->post('fk_modo_descarga_id')) {
            $this->form_validation->set_rules('numero_de_entregas', 'N&uacute;mero de entregas', 'trim|required|integer');
        }

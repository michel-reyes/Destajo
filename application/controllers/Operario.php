...
class Operario extends CI_Controller {
    ...
    public function validar()
    {
        ...
        $this->form_validation->set_rules('chapa', 'Chapa', 'trim|required|max_length[5]|is_unique[m_operario.chapa]');
        $this->form_validation->set_rules('ci', 'Carn&eacute; de identidad', 'trim|required|min_length[11]|max_length[11]');
        ...
        $this->form_validation->set_rules('fk_categoria_operario_id', 'Categor&iacute;a del operario', 'trim|required');

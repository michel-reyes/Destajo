<?php echo form_open('lugar_descarga/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_lugar_descarga');
    $b_criterio = $this->session->userdata('buscar_criterio_lugar_descarga');
    $b_texto = $this->session->userdata('buscar_texto_lugar_descarga');
?>
    			...
    			<tr>
    				...
    				<td>
                        <select class="select2" name="buscar_campo[]" data-placeholder="Columna">
                            ...
                            <option value="capacidad_bombeo_turbina_cliente" <?php if($value=='capacidad_bombeo_turbina_cliente'): ?> selected="selected" <?php endif; ?>>Capacidad de bombeo</option>
                        </select>
                    </td>

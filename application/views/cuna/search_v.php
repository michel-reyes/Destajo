<?php echo form_open('cuna/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_cuna');
    $b_criterio = $this->session->userdata('buscar_criterio_cuna');
    $b_texto = $this->session->userdata('buscar_texto_cuna');
?>

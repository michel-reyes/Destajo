...
date: 2014.12.17
type: php module
path: application/views/tarifa_pago/tabla_v_v.php
    ...
    <table class="table-fixed-header fancyTable">
        ...
        <thead>
            <tr>
                ...
                <th>
                    <?php echo anchor($modulo['nombre'] . "/show_content/?ofield=tarifa_pago.tarifa_horario_escala&otype=" . $otype, 'Tarifa horario escala'); ?>
                </th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo mysql_to_number($row->tarifa_horario_escala,5); ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>

        ...
        <div class="navbar navbar-googlenav" id="main-toolbar">
            <div class="navbar-inner">                
                <div class="btn-toolbar">
                    ...
                    <!-- Autocalcular -->
                    <?php if ($this->users->can('SalidaSalarioTrabajador.Calcular')): ?>
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url($modulo['nombre'] . '/xmlSiscont'); ?>" class="comando-exportar-xml-siscont">
                                   <i class="icon-file-alt"></i> XML SISCONT
                                </a>   
                            </li>

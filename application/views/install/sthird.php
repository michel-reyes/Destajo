...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                <p>Todo bien. Haz logrado una parte de la instalaci&oacute;n. Destajo ahora se puede comunicar con tu base de datos. Si estas listo pasemos a...</p>
                <br/>
                <p>
                  <?php echo anchor('install/sthird', 'Instalar', array('class'=>'btn btn-default')); ?>
                </p>
            </div>
        </div>

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php echo form_open('install/sthird', '', array('install'=>'ok')); ?>
                ...
                <p>
                  <?php echo form_error('uebname'); ?>
                  <label><strong>Nombre de la Empresa</strong></label>
                  <input type="text" class="form-control" name="uebname" value="<?php echo set_value('uebname'); ?>">                  
                </p>
                ...
                <p>
                  ...
                  <input style="margin-left: 175px;" type="password" class="form-control" name="confirm_pass" value="<?php echo set_value('confirm_pass'); ?>">

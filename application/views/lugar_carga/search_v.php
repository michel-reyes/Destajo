<?php echo form_open('lugar_carga/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_lugar_carga');
    $b_criterio = $this->session->userdata('buscar_criterio_lugar_carga');
    $b_texto = $this->session->userdata('buscar_texto_lugar_carga');
?>

<?php echo form_open('permiso/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_permiso');
    $b_criterio = $this->session->userdata('buscar_criterio_permiso');
    $b_texto = $this->session->userdata('buscar_texto_permiso');
?>

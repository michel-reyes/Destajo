...
echo form_open($modulo['nombre'] . '/agregar', array('class'=>'main-form form-validate', 'id'=>'formulario_entrada')); ?>
                ...
                <div id="fragment-0">
                    <div class="row">
                        <div class="span4">
                            ...
                            <!-- Ayudante (Chapa) -->
                            <label for="fk_ayudante_id">Ayudante <span class="muted">(Chapa)</span></label>  
                            <select class="select2" name="fk_ayudante_id" id="fk_ayudante_id">
                                <option></option>
                                option
                                <?php if ($lista_operarios->num_rows() > 0): ?>
                                    <?php foreach ($lista_operarios->result() as $operario): ?>

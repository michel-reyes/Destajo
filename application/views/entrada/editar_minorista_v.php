...
date: 2015.05.11
type: php module
path: application/views/entrada/editar_minorista_v.php
                    ...
                    <div class="row">
                        <div class="span4">
                            ...
                            <select class="select2" name="fk_lugar_carga_id" id="fk_lugar_carga_id" data-placeholder="Seleccione el lugar de carga">
                            	<option></option>
                            	<?php if ( ! empty($lugares_carga)): ?>
                            		<?php foreach ($lugares_carga as $key => $value): ?>
                            			<option value="<?php echo $value->m_lugar_carga_id; ?>" <?php if($value->m_lugar_carga_id == $ibi->fk_lugar_carga_id): ?> selected="selected"; <?php endif; ?> >
                            				<?php echo $value->lugar_carga; ?>
                            			</option>
                            		<?php endforeach; ?>
                            	<?php endif; ?>
                            </select>
                            ...
                            <select class="select2" name="fk_municipio_id" id="fk_municipio_id" data-placeholder="Seleccione un municipio">
                                ...
                                <?php if( ! empty($municipios)): ?>
                                	<?php foreach ($municipios as $key => $value): ?>
                                		<option value="<?php echo $value->m_lugar_descarga_id; ?>" <?php if ($value->m_lugar_descarga_id == $ibi->fk_municipio_id): ?> selected="selected" <?php endif; ?>>
                                			<?php echo $value->lugar_descarga; ?>
                                		</option>
                                	<?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                            ...
                            <input value="<?php echo $ibi->km_totales_recorridos; ?>" type="text" name="km_totales_recorridos" id="km_totales_recorridos" data-numeric-format="decimal" />
                        ...
                        <div class="span4">
                            ...
                            <select name="fk_modo_descarga_id" id="fk_modo_descarga_id" class="select2" data-placeholder="Seleccione un modo de descarga">
                                <option></option>
                                <?php if(! empty($modos_descarga)): ?>
                                	<?php foreach($modos_descarga as $key => $value): ?>
                                		<option value="<?php echo $value->m_modo_descarga_id; ?>" <?php if($value->m_modo_descarga_id == $ibi->fk_modo_descarga_id): ?> selected="selected" <?php endif; ?>>
                                			<?php echo $value->modo; ?>
                                		</option>
                                	<?php endforeach; ?>
                                <?php endif; ?>

<?php echo form_open('producto/show_content', array('id'=>'form-search')); 
    // Obtener las busquedas almacenadas en session
    $b_campo = $this->session->userdata('buscar_campo_producto');
    $b_criterio = $this->session->userdata('buscar_criterio_producto');
    $b_texto = $this->session->userdata('buscar_texto_producto');
?>
    			...
    			<tr>
    				...
    				<td>
                        <select class="select2" name="buscar_campo[]" data-placeholder="Columna">
                            ...
                            <option value="tipo" <?php if($value=='tipo'): ?> selected="selected" <?php endif; ?>>Tipo</option>
                        </select>
                    </td>

	    ...
	    <div class="navbar navbar-googlenav" id="main-toolbar">
            <div class="navbar-inner">                
                <div class="btn-toolbar">
                    ...
                    <!-- Nuevo -->
                    <?php if ($this->users->can('Producto.Agregar')): ?>
                    <div class="btn-group">
                    ...
                    <div class="btn-group hide comando-editar-eliminar">
                        ...
                        <?php if ($this->users->can('Producto.Editar')): ?>
                        <a href="#" class="btn comando-editar hide">Editar</a>
                        <?php endif; ?>
                        
                        <?php if ($this->users->can('Producto.Eliminar')): ?>
                    ...
                    <div class="btn-group">
                        ...
                        $b_campo = $this->session->userdata('buscar_campo_producto');
